...
<head>
    ...
    <title>Blitzspot - Tambah Data Pengaduan</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="<?= base_url() . 'Staff' ?>" aria-expanded="true"><i class="ti-dashboard"></i><span>dashboard</span></a>
                            </li>
                            <li>
                                <a href="<?= base_url() . 'Staff/pengajuan' ?>" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>
                                        Pengajuan
                                    </span>
                                </a>
                            ...
                            <li class="active">
                                <a href="<?= base_url() . 'Staff/pengaduan' ?>" aria-expanded="true"><i class="fa fa-hand-lizard-o"></i>
                                    <span>
                                        Pengaduan
                                    </span>
                                </a>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="<?php echo base_url() . 'teknisi/pemeliharaan' ?>">Data Pengaduan</a></li>
                                <li><span>Pengaduan Keluhan</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php endif ?>
                                        <h4 class="header-title">Pengaduan Keluhan</h4>
                                        <p class="text-muted font-14 mb-4">Data utama pada proses pengaduan</p>
                                        <?php if (validation_errors()) : ?>
                                            <div class="alert alert-danger" role="alert">
                                                <strong><?php echo validation_errors(); ?></strong>
                                            </div>
                                        <?php endif ?>
                                        <?php echo form_open_multipart('staff/tambah_data_pengaduan2'); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file" name="info">
                                        </div>
                                        <div class="form-group">
