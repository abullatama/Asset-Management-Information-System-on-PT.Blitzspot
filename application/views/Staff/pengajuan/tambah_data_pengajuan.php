                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content mt-3" id="myTabContent">
                                            <div class="tab-pane fade show active" id="1" role="tabpanel" aria-labelledby="1-tab">
                                                <form action="<?php echo base_url() . 'staff/tambah_data_pengajuan_p' ?>" method="POST">
                                                    <span>
                                            ...
                                            <div class="tab-pane fade" id="2" role="tabpanel" aria-labelledby="profile-tab">
                                                <form action="<?php echo base_url() . 'staff/tambah_data_pengajuan_habis_pakai' ?>" method="POST">
                                                    <div class="form-group">
