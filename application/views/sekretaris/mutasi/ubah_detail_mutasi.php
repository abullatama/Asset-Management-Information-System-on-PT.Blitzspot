                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Ubah Data Mutasi</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Ubah Data mutasi</h4>
                                        ...
                                        <form action="<?php echo base_url() . 'Mutasi/ubah_data_mutasi' ?>" method="POST">
                                            <input class="form-control" type="text" name="id_mutasi" value="<?= implode($id) ?>" required>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Nama Pelanggan</label>
                                                <input class="form-control" type="text" id="nama_pelanggan" name="nama_pelanggan" value="<?= $nama_pelanggan ?>" placeholder="Nama Pelanggan" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Alamat</label>
                                                <textarea class="form-control" id="alamat" name="alamat" value="<?= $alamat ?>" placeholder="Alamat" rows="3" required><?= $alamat ?></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="row justify-content-center">
                                                <button type="submit" class="btn btn-primary btn-block mt-3 pr-4 pl-4">Ubah</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($aset as $a) {
                                    ...
                                    <tr class="text-left">
                                        ...
                                        <td><?php echo $a->tanggal_masuk ?></td>
                                        <td class="text-center border-left">
                                            <a href="#" class="badge badge-success" id="perangkat1" data-dismiss="modal" data-no_aset="<?= $a->no_aset ?>" data-merek="<?= $a->merek ?>" onclick="perangkat1()">
                                                <i class="fa fa-plus"></i>
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($aset as $a) {
                                    ...
                                    <tr class="text-left">
                                        ...
                                        <td><?php echo $a->tanggal_masuk ?></td>
                                        <td class="text-center border-left">
                                            <a href="#" class="badge badge-success" id="perangkat2" data-dismiss="modal" data-no_aset="<?= $a->no_aset ?>" data-merek="<?= $a->merek ?>" onclick="perangkat1()">
                                                <i class="fa fa-plus"></i>
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($aset as $a) {
                                    ...
                                    <tr class="text-left">
                                        ...
                                        <td><?php echo $a->tanggal_masuk ?></td>
                                        <td class="text-center border-left">
                                            <a href="#" class="badge badge-success" id="perangkat3" data-dismiss="modal" data-no_aset="<?= $a->no_aset ?>" data-merek="<?= $a->merek ?>" onclick="perangkat1()">
                                                <i class="fa fa-plus"></i>
                                            </a>
                                        </td>
                                    </tr>
