...
<head>
    ...
    <title>Blitzspot - Tambah Data Mutasi</title>
...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="<?php echo base_url() . 'sekretaris/mutasi' ?>">Data Mutasi</a></li>
                                <li><span>Tambah Data Mutasi</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Tambah Data mutasi</h4>
                                        <p class="text-muted font-14 mb-4">Data utama pada proses mutasi</p>
                                        <?php if (validation_errors()) : ?>
                                            <div class="alert alert-danger" role="alert">
                                                <strong><?php echo validation_errors(); ?></strong>
                                            </div>
                                        <?php endif ?>
                                        <form action="<?php echo base_url() . 'Mutasi/tambah_data_mutasi' ?>" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <input class="form-control" type="hidden" id="no_detail" name="no_detail">
                                                ...
                                                <span id="form">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                            ...
                                                            <input class="form-control" type="hidden" id="no_detail1" name="no_detail1">
                                                            <input class="form-control" type="text" id="merek1" name="perangkat2" placeholder=" Pilih Perangkat" readonly>
                                                        </div>
                                                    </div>
                                                </span>
                                                ...
                                                <span id="form1">
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#modal-aset2">Pilih</button>
                                                        </div>
                                                        <div class="custom-file">
                                                            <input class="form-control" type="hidden" id="no_aset2" name="no_aset2">
                                                            <input class="form-control" type="hidden" id="no_detail2" name="no_detail2">
                                                            <input class="form-control" type="text" id="merek2" name="perangkat3" placeholder=" Pilih Perangkat" readonly>
                                                        </div>
                                                    </div>
                                                </span>
                                                ...
                                                <span id="form2">
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#modal-aset3">Pilih</button>
                                                        </div>
                                                        <div class="custom-file">
                                                            <input class="form-control" type="hidden" id="no_aset3" name="no_aset3">
                                                            <input class="form-control" type="hidden" id="no_detail3" name="no_detail3">
                                                            <input class="form-control" type="text" id="merek3" name="perangkat4" placeholder="Pilih Perangkat" readonly>
                                                        </div>
                                                    </div>
                                                </span>

                                                <span id="tambah1">
                                                    <h4><a onclick="tambah1()"><i class="fa fa-plus-circle" style="padding-left:20px"></i></a></h4>
                                                </span>
                                                <span id="tambah2">
                                                    <h4><a onclick="tambah2()"><i class="fa fa-plus-circle" style="padding-left:20px"></i></a></h4>
                                                </span>
                                                <span id="tambah3">
                                                    <h4><a onclick="tambah3()"><i class="fa fa-plus-circle" style="padding-left:20px"></i></a></h4>
                                                </span>
                                            </div>
                                            <div class="row justify-content-center">
                                ...
                                foreach ($aset as $a) {
                                    ...
                                    <tr class="text-left">
                                        ...
                                        <td class="text-center border-left">
                                            <a href="#" class="badge badge-success" id="perangkat" data-dismiss="modal" data-no_aset="<?= $a->no_aset ?>" data-no_detail="<?= $a->no_detail ?>" data-merek="<?= $a->merek ?>" onclick="perangkat1()">
    ...
    <div class="modal fade bd-example-modal-lg" id="modal-aset1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="data-tables">
                        <table id="modalaset1" class="text-center responsive" style="width=100%">
                            <thead class="bg-light text-capitalize">
                                <tr class="text-left">
                                    <th>No</th>
                                    <th>No Aset</th>
                            ...
                            <tbody>
                                ...
                                foreach ($aset as $a) {
                                    ...
                                    <tr class="text-left">
                                        ...
                                        <td><?php echo $a->tanggal_masuk ?></td>
                                        <td class="text-center border-left">
                                            <a href="#" class="badge badge-success" id="perangkat1" data-dismiss="modal" data-no_aset="<?= $a->no_aset ?>" data-no_detail="<?= $a->no_detail ?>" data-merek="<?= $a->merek ?>" onclick="perangkat1()">
                                                <i class="fa fa-plus"></i>
                                            </a>
                                        </td>
                                    </tr>
    ...
    <!--modal3-->
    <div class="modal fade bd-example-modal-lg" id="modal-aset2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Data Aset</h5>
                ...
                <div class="modal-body">
                    <div class="data-tables">
                        <table id="modalaset2" class="text-center responsive" style="width=100%">
                            <thead class="bg-light text-capitalize">
                                <tr class="text-left">
                                    <th>No</th>
                                    <th>No Aset</th>
                            ...
                            <tbody>
                                ...
                                foreach ($aset as $a) {
                                    ...
                                    <tr class="text-left">
                                        ...
                                        <td><?php echo $a->tanggal_masuk ?></td>
                                        <td class="text-center border-left">
                                            <a href="#" class="badge badge-success" id="perangkat2" data-dismiss="modal" data-no_aset="<?= $a->no_aset ?>" data-no_detail="<?= $a->no_detail ?>" data-merek="<?= $a->merek ?>" onclick="perangkat1()">
                                                <i class="fa fa-plus"></i>
                                            </a>
                                        </td>
                                    </tr>
    ...
    <!--modal4-->
    <div class="modal fade bd-example-modal-lg" id="modal-aset3" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Data Aset</h5>
                ...
                <div class="modal-body">
                    <div class="data-tables">
                        <table id="modalaset3" class="text-center responsive" style="width=100%">
                            <thead class="bg-light text-capitalize">
                                <tr class="text-left">
                                    <th>No</th>
                                    <th>No Aset</th>
                            ...
                            <tbody>
                                ...
                                foreach ($aset as $a) {
                                    ...
                                    <tr class="text-left">
                                        ...
                                        <td><?php echo $a->tanggal_masuk ?></td>
                                        <td class="text-center border-left">
                                            <a href="#" class="badge badge-success" id="perangkat3" data-dismiss="modal" data-no_aset="<?= $a->no_aset ?>" data-no_detail="<?= $a->no_detail ?>" data-merek="<?= $a->merek ?>" onclick="perangkat1()">
                                                <i class="fa fa-plus"></i>
                                            </a>
                                        </td>
                                    </tr>
    ...
    <script>
        ...
        function tambah2() {
            ...
            document.getElementById("tambah3").style.display = "block";
        }
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("#modalaset1").dataTable();
        });
        $(function() {
            $("#modalaset2").dataTable();
        });
        $(function() {
            $("#modalaset3").dataTable();
        });
        ...
        $(document).on("click", "#perangkat1", function() {
            var no_aset = $(this).data('no_aset');
            var no_detail = $(this).data('no_detail');
            var merek = $(this).data('merek');
            $("#no_aset1").val(no_aset);
            $("#no_detail1").val(no_detail);
            $("#merek1").val(merek);
        })
        $(document).on("click", "#perangkat2", function() {
            var no_aset = $(this).data('no_aset');
            var merek = $(this).data('merek');
            var no_detail = $(this).data('no_detail');
            $("#no_aset2").val(no_aset);
            $("#no_detail2").val(no_detail);
            $("#merek2").val(merek);
        })
        $(document).on("click", "#perangkat3", function() {
            var no_aset = $(this).data('no_aset');
            var no_detail = $(this).data('no_detail');
            var merek = $(this).data('merek');
            $("#no_aset3").val(no_aset);
            $("#no_detail3").val(no_detail);
            $("#merek3").val(merek);
        })
    </script>
    <!-- bootstrap 4 js -->
