...
<head>
    ...
    <title>Blitzspot - Laporan Pemeliharaan</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="<?php echo base_url() . 'direktur/laporan_pemeliharaan' ?>">Pemeliharaan</a></li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><span>Laporan Pemeliharaan</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="modal fade" id="modal-cetak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url() . 'direktur/cetak_laporan_pemeliharaan' ?>" method="post">
