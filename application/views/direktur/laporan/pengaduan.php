                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="<?php echo base_url() . 'direktur/laporan_pengaduan' ?>">Pengaduan</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
                                ...
                                <div class="modal fade" id="modal-cetak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url() . 'direktur/cetak_laporan_pengaduan' ?>" method="post">
