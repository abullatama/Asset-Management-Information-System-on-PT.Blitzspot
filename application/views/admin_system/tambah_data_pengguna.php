...
<head>
    ...
    <title>Blitzspot - Tambah Data Pengguna</title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li><a href="<?php echo base_url() . 'admin_system/pengguna' ?>">Data Pengguna</a></li>
                                    <li class="active"><a href="<?php echo base_url() . 'admin_system/tambah_data_pengguna' ?>">Tambah Data Pengguna</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><span>Tambah Data Pengguna</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Tambah Data Pengguna</h4>
                                        <p class="text-muted font-14 mb-4">Data utama pengguna</p>
                                        <?php if (validation_errors()) : ?>
                                            <div class="alert alert-danger" role="alert">
                                                <strong><?php echo validation_errors(); ?></strong>
                                            </div>
                                        <?php endif ?>
                                        <form action="<?php echo base_url() . 'admin_system/tambah_data_pengguna_p' ?>" method="POST">
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Nama Pengguna</label>
                                                <input class="form-control" type="text" id="nama_pengguna" name="nama_pengguna" placeholder="Nama Pengguna" required>
                                            </div>
                                            <div class="form-group">
