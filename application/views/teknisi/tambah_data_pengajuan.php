...
<head>
    ...
    <title>Blitzspot - Pengajuan</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="<?= base_url() . 'Teknisi' ?>" aria-expanded="true"><i class="ti-dashboard"></i><span>dashboard</span></a>
                            </li>
                            <li>
                                <a href="<?= base_url() . 'Teknisi/pemeliharaan' ?>" aria-expanded="true"><i class="ti-layout-slider"></i>
                                    <span>
                                        Pemeliharaan
                                    </span>
                                </a>
                            ...
                            <li class="active">
                                <a href="<?= base_url() . 'Teknisi/pengajuan' ?>" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>
                                        Pengajuan
                                    </span>
                                </a>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><span>Tambah Data Pengajuan</span></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <?php if ($this->session->flashdata('flash')) : ?>
                                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                                Data Pengajuan <strong>berhasil</strong> <?php echo $this->session->flashdata('flash'); ?>.
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                        <?php endif ?>
                                        <h4 class="header-title">Tambah Data Pengajuan</h4>
                                        <p class="text-muted font-14 mb-4">Data utama pada proses pengajuan</p>
                                        ...
                                        <div class="tab-content mt-3" id="myTabContent">
                                            <div class="tab-pane fade show active" id="1" role="tabpanel" aria-labelledby="1-tab">
                                                <form action="<?php echo base_url() . 'pengajuan/tambah_data_pengajuan' ?>" method="POST">
                                            ...
                                            <div class="tab-pane fade" id="2" role="tabpanel" aria-labelledby="profile-tab">
                                                <form action="<?php echo base_url() . 'Pengajuan/tambah_data_pengajuan_habis_pakai' ?>" method="POST">
                                                    <div class="form-group">
                                                        <label for="example-text-input" class="col-form-label">Nama Barang</label>
                                                        <input class="form-control" type="text" id="nama_aset" name="nama_aset" placeholder="Nama Barang">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="example-text-input" class="col-form-label">Jenis Aset</label>
