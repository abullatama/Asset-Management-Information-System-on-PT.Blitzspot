...
<body>
                                                    ...
                                                    foreach ($pengajuan as $a) {
                                                        ...
                                                        <tr class="text-left">
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php } else { ?>
                                                                    <a href="#" class="badge badge-success" id="edit">
                                                                        <h6><i class="fa fa-plus"></i></h6>
                                                                    </a>
    ...
    <div class="modal fade" id="modal-ubah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="<?= base_url() . 'bendahara/ubah_data_pengajuan_p' ?>" method="post">
