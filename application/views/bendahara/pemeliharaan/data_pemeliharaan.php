                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Data Pemeliharaan</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php endif ?>
                                <h4 class="header-title">Riwayat Pemeliharaan</h4>
                                <!--cetak-->
                                    ...
                                    <table id="dataTable1" class="text-center table-striped responsive" style="width=100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-left">
                                                ...
                                                <td><?php echo $a->tanggal_pemeliharaan ?></td>
                                                <td><?php echo 'Rp.' . $a->biaya ?></td>
                                                <td><?php echo $a->kondisi_pemeliharaan ?></td>
                                                <td><?php echo $a->keterangan ?></td>
                                                <td class="text-center border-left">
                                                    <a href="" data-toggle="modal" data-target="#modal-edit" id="edit" data-no_pemeliharaan="<?= $a->no_pemeliharaan ?>" data-no_aset="<?= $a->no_aset ?>" data-nama_aset="<?= $a->nama_aset ?>" data-tanggal_pemeliharaan="<?= $a->tanggal_pemeliharaan ?>" data-kondisi_pemeliharaan="<?= $a->kondisi_pemeliharaan ?>" data-biaya="<?= $a->biaya ?>" data-keterangan="<?= $a->keterangan ?>" class="badge badge-warning">
                                ...
                                <a href="<?php echo base_url() . 'bendahara/tambah_data_pemeliharaan' ?>">
                                    <button type="button" class="btn btn-success mb-3">Tambah Data Pemeliharaan</button>
                                </a>
                            </div>
                        </div>
                    </div>
