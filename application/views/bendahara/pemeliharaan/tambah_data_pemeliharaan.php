...
<head>
    ...
    <title>Blitzspot - Tambah Data Pemeliharaan</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Pemeliharaan</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="<?php echo base_url() . 'teknisi/pemeliharaan' ?>">Data Pemeliharaan</a></li>
                                <li><span>Tambah Data Pemeliharaan</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Tambah Riwayat Pemeliharaan</h4>
                                        <p class="text-muted font-14 mb-4">Data utama pada proses pemeliharaan</p>
                                        <?php if (validation_errors()) : ?>
                                            <div class="alert alert-danger" role="alert">
                                                <strong><?php echo validation_errors(); ?></strong>
                                            </div>
                                        <?php endif ?>
                                        <form action="<?php echo base_url() . 'pemeliharaan/tambah_data_pemeliharaan' ?>" method="POST">
