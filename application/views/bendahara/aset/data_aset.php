...
<head>
    ...
    <title>Blitzspot - Data Aset</title>
...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="header-title">
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-right">
                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-stok"><b><i class="fa fa-gear"></i> Kelola Stok</b></button>
                                        </div>
                                    </div>
                                </h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-left">
                                                        ...
                                                        <td class="text-center border-left">
                                                            <a href="#" class="badge badge-warning" id="edit" data-toggle="modal" data-target="#modal-edit" data-no_aset="<?= $a->no_aset ?>" data-nama_aset="<?= $a->nama_aset ?>" data-jenis_aset="<?= $a->jenis_aset ?>" data-merek="<?= $a->merek ?>" data-tipe="<?= $a->tipe ?>" data-spesifikasi="<?= $a->spesifikasi ?>" data-harga="<?= $a->harga ?>" data-kondisi="<?= $a->kondisi ?>" data-lokasi="<?= $a->lokasi ?>" data-tanggal_masuk="<?= $a->tanggal_masuk ?>">
                                                                <h6><i class="fa fa-pencil"></i></h6>
                                                            </a>
                                                            <a href="#" class="badge badge-danger" id="hapus" data-toggle="modal" data-target="#modal-hapus" data-no_aset="<?= $a->no_aset ?>" data-no_detail="<?= $a->no_detail ?>">
                                            ...
                                            <table id="dataTable5" class="text-center responsive" style="width=100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-left">
                                                        ...
                                                        <td class="text-center border-left" style="width:10%">
                                                            <a href="#" class="badge badge-warning" id="edit2" data-toggle="modal" data-target="#modal-edit2" data-no_aset="<?= $i->no_aset ?>" data-nama_aset="<?= $i->nama_aset ?>" data-jenis_aset="<?= $i->jenis_aset ?>" data-jumlah="<?= $i->jumlah ?>" data-harga="<?= $i->harga ?>">
                                                                <h6><i class="fa fa-pencil"></i></h6>
                                                            </a>
                                                            <a href="#" class="badge badge-danger" id="hapus" data-toggle="modal" data-target="#modal-hapus" data-no_aset="<?= $i->no_aset ?>">
                                                                <h6><i class="fa fa-trash"></i></h6>
                                                            </a>
                                                        </td>
                                                    </tr>
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url() . 'aset/hapus_data_aset' ?>" method="post">
                    <div class="modal-body">
                        ...
                        <input type="text" id="no_aset" name="no_aset">
    ...
    <!-- Modal stok-->
    <div class="modal fade bd-example-modal-lg" id="modal-stok" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Kelola Stok</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <table id="dataTable6" class="text-center responsive" style="width=100%">
                        <thead class="bg-light text-capitalize">
                            <tr class="text-left">
                                <th>No</th>
                                <th>Nama Aset</th>
                        ...
                        <tbody>
                            ...
                            <tr class="text-left">
                                <td><?php echo $no++ ?></td>
                                <td><?php echo $i->nama_aset ?></td>
                                <?php if ($i->minimal_stok == 0) {  ?>
                                <td><input type="text" class="form-control" value="<?php echo $i->stok ?>" readonly></td>
                                <td><input type="text" class="form-control" value="<?php echo $i->minimal_stok ?>" readonly></td>
                                <td class="text-center"><a href="#"><button type="submit" class="btn btn-warning" disable><i class="fa fa-pencil"></i> Ubah</button></a></td>
                                <?php } else { ?>
                                <form action="<?= base_url() . 'aset/ubah_detail_aset' ?>" method="post">
                                    <td><input type="hidden" class="form-control" name="no_detail" value="<?php echo $i->no_detail ?>"><input type="text" class="form-control" name="stok" value="<?php echo $i->stok ?>"></td>
                                    <td><input type="text" class="form-control" name="minimal_stok" value="<?php echo $i->minimal_stok ?>"></td>
                                    <td class="text-center"><a href=""><button type="submit" class="btn btn-warning"><i class="fa fa-pencil"></i> Ubah</button></a></td>
                                </form>
                                <?php } ?>
                            </tr>
                            <?php
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="example-tel-input" class="col-form-label">Jumlah</label>
