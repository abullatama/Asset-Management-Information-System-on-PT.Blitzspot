...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="<?php echo base_url() . 'bendahara/perencanaan' ?>">Data Perencanaan</a></li>
                                <li><span>Tambah Data Perencanaan</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Tambah Data Perencanaan</h4>
                                        <p class="text-muted font-14 mb-4">Menambahkan data pada proses perencanaan pengadaan</p>
                                                    ...
                                                    <div class="form-group" id="new">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#modal-perencanaan">Pilih</button>
                                                            </div>
                                                            <div class="custom-file">
                                                                <input class="form-control" type="text" id="nama" name="new" placeholder="Pilih Barang" readonly>
                                                            </div>
                                                        </div>
    ...
    <!--modal perencanaan-->
    <div class="modal fade bd-example-modal-lg" id="modal-perencanaan" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                ...
                                foreach ($aset as $a) {
                                    if ($a->minimal_stok != 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $a->minimal_stok - $a->stok ?></td>
                                            <td>
                                                <a href="#" class="badge badge-success" id="perangkat" data-dismiss="modal" data-nama_aset="<?= $a->nama_aset ?>">
